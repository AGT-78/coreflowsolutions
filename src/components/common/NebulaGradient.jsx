...
const NebulaGradient = () => {
  return (
    <div className="relative flex items-center justify-center p-4 md:p-8 overflow-hidden bg-[#0d0d0d] rounded-3xl min-h-[600px] w-full border border-white/5">
      ...
      >
        ...
        <div className="relative w-full max-w-5xl rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
